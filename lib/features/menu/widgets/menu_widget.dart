...
class MenuBottomSheetWidget extends StatelessWidget {
    ...
    return Consumer<SplashController>(
      builder: (context, splashController, _) {
        ...
        List<CustomBottomSheetWidget> activateMenu = [
          ...
          // Opens the seller-only package and insurance status screen.
          CustomBottomSheetWidget(image: Images.wallet, title: 'Packages',
          ...
          CustomBottomSheetWidget(image: Images.productIconPp, title: 'Promotions',
  ...
  Future<void> _openAddProductIfEligible(BuildContext context) async {
    ...
    if (reason != null) {
      // Direct sellers to the only screen where insurance or package activation can be completed.
