...
class AppConstants {
  ...
  // Seller package overview includes active plan, insurance state, and available package plans.
  ...
  // Seller insurance has its own lifecycle and payment records, even though it shares gateway settings.
  static const String sellerInsuranceStatusUri = '/api/v3/seller/insurance/status';
  static const String sellerInsurancePayUri = '/api/v3/seller/insurance/pay';
  static const String sellerInsuranceOfflinePaymentUri = '/api/v3/seller/insurance/offline-payment';
